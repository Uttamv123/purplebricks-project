export const metadata = { title: 'Terms & Conditions — 1HouseToHome India' };

const sections = [
  { title: '1. Acceptance of Terms', body: 'By accessing or using 1HouseToHome India ("Platform"), you agree to be bound by these Terms & Conditions. If you do not agree, please do not use our Platform. These terms constitute a legally binding agreement between you and 1HouseToHome India Pvt. Ltd., governed by the laws of India.' },
  ...
  { title: '3. Platform Services', body: `1HouseToHome provides an online marketplace for:
...
1HouseToHome is a facilitator and is not a party to any transaction between buyers and sellers. We do not own, manage, or control any listed properties.` },
...
• Not infringe on intellectual property rights of 1HouseToHome or third parties
• Not attempt to hack, scrape, or reverse-engineer the Platform` },
  { title: '5. RERA Compliance', body: 'All property listings on 1HouseToHome must comply with the Real Estate (Regulation and Development) Act, 2016 (RERA). Developers and agents are responsible for ensuring their listings are RERA registered. 1HouseToHome displays RERA registration numbers as provided by listers but does not independently verify all listings.' },
  ...
  { title: '7. Intellectual Property', body: 'All content on the Platform including text, graphics, logos, images, and software is the property of 1HouseToHome India Pvt. Ltd. and is protected under the Copyright Act, 1957. You may not reproduce, distribute, or create derivative works without our written permission.' },
  { title: '8. Disclaimer of Warranties', body: 'The Platform is provided "as is" without warranties of any kind. 1HouseToHome does not guarantee the accuracy of property listings, prices, or availability. We are not responsible for any loss arising from reliance on information on the Platform.' },
  { title: '9. Limitation of Liability', body: 'To the maximum extent permitted by Indian law, 1HouseToHome shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Platform. Our total liability shall not exceed the fees paid by you in the 3 months preceding the claim.' },
  ...
  { title: '11. Contact', body: 'For legal queries: legal@1HouseToHome.in\n1HouseToHome India Pvt. Ltd., 4th Floor, Prestige Tech Park, Outer Ring Road, Bengaluru – 560103' },
];
